...
<body translate="no">
    ...
    <div id="invoice-POS">
        ...
        <div id="mid">
            <div class="info">
                <h2>Info Struk</h2>
                <h2>Kode Struk : <?= $Data->kode_transaksi ?></h2>
                <p>
                    Nama Toko : <?= $konten[0]->isi ?></br>
                    Email : <?= $konten[1]->isi ?></br>
                    Telephone :  <?= $konten[2]->isi ?></br>
                </p>
            </div>
        </div>
        <!--End Invoice Mid-->
            ...
            <div id="table">
                <table>
                    ...
                    <?php foreach ($getData as $key => $value) {
                        ...
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext"><?= $value->nama_menu ?></p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext"><?= $value->qty ?></p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext"><?= $value->total ?></p>
                            </td>
                        </tr>
